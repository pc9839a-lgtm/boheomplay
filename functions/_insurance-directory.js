...
export const insuranceProducts = [
  { slug:'aia-global-power-dollar-annuity', name:'(무)AIA 글로벌 파워 미국달러 연금보험 (1형 연금강화형_최저계약자적립액 보증형)', companySlug:'aia-life', category:'외화 연금보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/saving/non-par-aia-global-power-us-dollar-annuity.html', summary:'달러 기준 계약자적립액 보증 조건과 연금·해약환급금의 통화 기준을 공식 문서로 확인해야 하는 외화 연금보험입니다.', checks:['보증 기준일과 보증 대상 적립액','달러 보험료와 원화환산 납입 조건','연금개시 전 계약 변경의 영향','중도인출·감액·해지 조건','외화보험 환율과 환전 비용'], questions:[{slug:'aia-global-power-dollar-annuity-guarantee-check',title:'AIA생명 (무)AIA 글로벌 파워 미국달러 연금보험의 계약자적립액 보증 기준은 어떻게 확인하나요?',summary:'계약자적립액 보증 시점과 외화 기준을 확인합니다.'}] },
  { slug:'aia-dollar-annuity-ii', name:'(무)AIA 달러로 받는 연금보험 II (10년 이율 확정형)', companySlug:'aia-life', category:'외화 연금보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/saving/non-par-aia-dollar-annuity.html', summary:'달러 기준 적립액과 중도인출 조건, 연금재원의 변화를 공식 상품문서에서 확인해야 하는 외화 연금보험입니다.', checks:['이율확정기간과 이후 적용이율','중도인출 가능 시점과 한도','중도인출 수수료','달러·원화 수령 방식','환율 변동과 연금재원 영향'], questions:[{slug:'aia-dollar-annuity-ii-withdrawal-check',title:'AIA생명 (무)AIA 달러로 받는 연금보험 II의 중도인출 조건은 어떻게 확인하나요?',summary:'중도인출 조건과 인출 후 연금재원을 확인합니다.'}] },
  { slug:'aia-global-legacy-dollar-inheritance-whole-life', name:'(무)AIA 글로벌 레거시 미국달러 상속종신보험', companySlug:'aia-life', category:'외화 종신보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/life-protection/non-par-aia-global-legacy-us-dollar-inheritance-whole-life.html', summary:'달러 표시 사망보험금과 실제 지급 통화, 계약 당사자 관계를 공식 약관으로 확인해야 하는 외화 종신보험입니다.', checks:['사망보험금 표시 통화','원화환산 지급 조건','계약자·피보험자·수익자 관계','보험금 지급 제한','외화보험 위험과 세무 별도 검토'], questions:[{slug:'aia-global-legacy-dollar-inheritance-benefit-check',title:'AIA생명 (무)AIA 글로벌 레거시 미국달러 상속종신보험의 사망보험금 지급 통화는 어떻게 확인하나요?',summary:'사망보험금 지급 통화와 수익자 조건을 확인합니다.'}] },
  { slug:'aia-ceo-term-life', name:'(무)AIA 안심+ 경영인 정기보험 (해약환급금 일부지급형)', companySlug:'aia-life', category:'경영인 정기보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/life-protection/non-par-ceo-term-life.html', summary:'법인 계약 당사자와 보장 목적, 경과기간별 해약환급금 구조를 구분해 확인해야 하는 정기보험입니다.', checks:['계약자·피보험자·수익자','법인 보험료 납부 주체','보장기간과 지급 조건','해약환급금 일부지급형 구조','회계·세무 별도 검토'], questions:[{slug:'aia-ceo-term-life-contract-purpose-check',title:'AIA생명 (무)AIA 안심+ 경영인 정기보험은 법인 계약에서 무엇을 구분해 확인해야 하나요?',summary:'법인 계약의 당사자와 환급 구조를 확인합니다.'}] },
  { slug:'aia-prime-dollar-whole-life', name:'(무)AIA 안심+ 프라임 달러 종신보험(해약환급금 50% 지급형)', companySlug:'aia-life', category:'외화 종신보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/life-protection/non-par-aia-peace-of-mind-prime-dollar-whole-life-csv-50type.html', summary:'달러 표시 보험료·보험금과 해약환급금 50% 지급형의 비교 기준을 공식 문서로 확인해야 하는 종신보험입니다.', checks:['정확한 종·형과 납입기간','50% 지급형 비교 기준','경과기간별 해약환급금','달러·원화 환산 조건','사망보험금 지급 조건'], questions:[{slug:'aia-prime-dollar-whole-life-exchange-risk-check',title:'AIA생명 (무)AIA 안심+ 프라임 달러 종신보험의 환율 변동과 해약환급금은 어떻게 확인하나요?',summary:'환율 변동과 해약환급금 산정 기준을 확인합니다.'}] },
  { slug:'aia-universal-whole-life', name:'(무)AIA 평생 안심+ 유니버셜 종신보험', companySlug:'aia-life', category:'유니버셜 종신보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/life-protection/non-par-universal-whole-life.html', summary:'추가납입과 중도인출 등 유니버셜 기능 사용 후 계약 유지 조건을 공식 약관으로 확인해야 하는 종신보험입니다.', checks:['의무납입기간','추가납입 한도','중도인출 조건','월대체보험료','기능 사용 후 계약 유지와 환급금'], questions:[{slug:'aia-universal-whole-life-flexibility-check',title:'AIA생명 (무)AIA 평생 안심+ 유니버셜 종신보험의 추가납입·중도인출 전 무엇을 확인해야 하나요?',summary:'유니버셜 기능 사용 후 계약 유지 영향을 확인합니다.'}] },
  { slug:'aia-simplified-health-renewal', name:'(무)AIA 더 안심되는 초간편 건강보험 (갱신형)', companySlug:'aia-life', category:'간편심사 건강보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/critical-illness/non-par-aia-305-simplified-issued-health-plan-renewal.html', summary:'실제 청약서의 간편심사 질문과 갱신주기, 보험료 변동 가능성을 공식 문서로 확인해야 하는 건강보험입니다.', checks:['간편심사 청약서 질문','진료·검사·투약 이력','일반심사형과의 차이','갱신주기와 갱신 가능 연령','갱신 시 보험료 변동 가능성'], questions:[{slug:'aia-simplified-health-renewal-disclosure-check',title:'AIA생명 (무)AIA 더 안심되는 초간편 건강보험(갱신형)의 고지 질문과 갱신 조건은 어떻게 확인하나요?',summary:'고지 질문과 갱신 조건을 확인합니다.'}] },
  { slug:'aia-build-your-own-comprehensive', name:'(무)AIA 내가 조립하는 종합보장보험', companySlug:'aia-life', category:'종합보장보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/medical-protection/non-par-aiavitality-i-assemble-comprehensive-health-plan.html', summary:'최종 청약서에 선택된 주계약과 특약, 갱신 여부와 지급 조건을 개별적으로 확인해야 하는 종합보장보험입니다.', checks:['선택한 주계약과 특약','특약별 지급 사유','갱신형·비갱신형 구분','납입기간과 보장기간','기존 계약과 중복 여부'], questions:[{slug:'aia-build-your-own-coverage-rider-check',title:'AIA생명 (무)AIA 내가 조립하는 종합보장보험의 선택 특약과 보장기간은 어떻게 정리하나요?',summary:'선택 특약과 보장기간을 표로 정리합니다.'}] },
  { slug:'aia-health-plus-cancer-renewal', name:'(무)AIA 건강+ 암보험(갱신형)', companySlug:'aia-life', category:'갱신형 암보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.aia.co.kr/ko/products/medical-protection/non-par-health-plus-cancer-plan-renewal-bb.html', summary:'암 분류별 지급금액과 선택 특약, 갱신주기와 보험료 변동 가능성을 공식 문서로 확인해야 하는 암보험입니다.', checks:['일반암·유사암·특정암 분류','특약별 지급 사유','면책기간과 감액기간','갱신주기와 갱신 가능 연령','갱신 보험료 변동 가능성'], questions:[{slug:'aia-health-plus-cancer-renewal-coverage-check',title:'AIA생명 (무)AIA 건강+ 암보험(갱신형)의 암 분류와 갱신 조건은 무엇을 확인해야 하나요?',summary:'암 분류와 특약·갱신 조건을 확인합니다.'}] },
  { slug:'metlife-dollar-whole-life-plus', name:'(무)백만인을 위한 달러종신보험 Plus [저해약환급금형]', companySlug:'metlife-korea', category:'외화 종신보험', verifiedAt:'2026-07-16', status:'판매중 확인', officialUrl:'https://www.emetlife.kr/USDwholelife/', summary:'원화 납입과 달러 표시 보험금, 저해약환급금형의 경과기간별 구조를 공식 상품문서에서 확인해야 하는 종신보험입니다.', checks:['달러 보험료와 원화 납입액','보험금 수령 통화','적용 환율과 환전 비용','경과기간별 해약환급금','외화보험 위험 안내'], questions:[{slug:'metlife-dollar-whole-life-plus-currency-check',title:'메트라이프생명 (무)백만인을 위한 달러종신보험 Plus의 원화 납입·달러 보장 내역은 어떻게 확인하나요?',summary:'원화 납입·달러 보장과 환급 구조를 확인합니다.'}] }
];
