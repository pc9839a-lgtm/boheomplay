...
const SCRIPTS='<script src="/assets/js/compliance.js?v=20260712-v4"></script><script src="/assets/js/agent-info.js?v=20260712-v1"></script>';
const NOTICE='<section class="site-compliance-notice"><div class="site-compliance-inner"><strong>보험정보 이용안내</strong>보험플레이의 게시글과 답변은 일반적인 보험정보 제공을 위한 것이며 특정 보험상품의 가입 권유, 보험계약 체결 또는 중개를 위한 설명이 아닙니다.<div class="site-compliance-registration">보험모집종사자: 김도윤 · 소속: 지에이코리아주식회사 · 보험협회 고유번호: 20260217401069 · 조회 기준일: 2026.07.12</div><div class="site-compliance-links"><a href="https://www.e-cleanins.or.kr/" target="_blank" rel="noopener noreferrer">이클린보험서비스에서 정보 확인</a><a href="/insurance-notice/">보험정보 이용안내</a><a href="/privacy/">개인정보처리방침</a><a href="/terms/">이용약관</a></div></div></section>';
...
function patchHtml(html){
  ...
  if(!out.includes('property="og:image"')) out=out.replace('</head>',`<meta property="og:image" content="${OG}"/><meta property="og:image:secure_url" content="${OG}"/><meta property="og:image:width" content="1200"/><meta property="og:image:height" content="630"/><meta property="og:image:type" content="image/jpeg"/><meta name="twitter:image" content="${OG}"/>${SCRIPTS}</head>`);
  else if(!out.includes('/assets/js/agent-info.js')) out=out.replace('</head>',`${SCRIPTS}</head>`);
