...
const BOARD_SCRIPT='<script src="/assets/js/board-router.js?v=20260715-v2"></script>';
const LOCAL_PURGE_SCRIPT='<script src="/assets/js/purge-local-posts.js?v=20260715-v1"></script>';
