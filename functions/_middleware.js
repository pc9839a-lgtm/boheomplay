...
const BOARD_UI='<script src="/assets/js/board-ui-restore.js?v=20260715-board-restore-v11"></script>';
...
function patchHtml(html){
  let out=html
    ...
    .replace(/\/assets\/js\/config\.js\?v=[^"']+/g,'/assets/js/config.js?v=20260715-board-restore-v11')
    .replace(/\/assets\/js\/main\.js\?v=[^"']+/g,'/assets/js/main.js?v=20260715-board-restore-v11');
