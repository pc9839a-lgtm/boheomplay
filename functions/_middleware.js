...
function patchHtml(html){
  let out=html
    ...
    .replace(/\/assets\/js\/config\.js\?v=[^"']+/g,'/assets/js/config.js?v=20260715-canonical-board-v7')
    .replace(/\/assets\/js\/main\.js\?v=[^"']+/g,'/assets/js/main.js?v=20260715-canonical-board-v7');
