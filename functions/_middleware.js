...
function patchHtml(html){
  let out=html
    ...
    .replaceAll('/assets/js/config.js?v=20260710-center-sections','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/config.js?v=20260715-board-router-v2','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/config.js?v=20260715-user-post-purge-v1','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/config.js?v=20260715-user-post-purge-v2','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/config.js?v=20260715-board-storage-fix-v1','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/config.js?v=20260715-board-live-v2','/assets/js/config.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/main.js?v=20260710-center-sections','/assets/js/main.js?v=20260715-board-live-v3')
    .replaceAll('/assets/js/main.js?v=20260715-board-live-v2','/assets/js/main.js?v=20260715-board-live-v3');
