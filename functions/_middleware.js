...
const COMPLIANCE_SCRIPT = '<script src="/assets/js/compliance.js?v=20260712-v2"></script>';
const COMMON_NOTICE = `<section class="site-compliance-notice" aria-label="보험정보 이용안내" style="border-top:1px solid #e5e5e5;background:#f7f7f7"><div class="site-compliance-inner" style="max-width:1180px;margin:0 auto;padding:24px 20px;color:#555;font-size:13px;line-height:1.75"><strong style="display:block;margin-bottom:6px;color:#111;font-size:14px">보험정보 이용안내</strong>보험플레이의 게시글과 답변은 일반적인 보험정보 제공을 위한 것이며 특정 보험상품의 가입 권유, 보험계약 체결 또는 중개를 위한 설명이 아닙니다. 실제 보험료, 보장내용과 가입 가능 여부는 보험회사·상품·개인의 연령, 직업, 병력 및 인수 기준에 따라 달라질 수 있습니다. 기존 보험을 해지하거나 변경하기 전에는 상품설명서와 약관을 확인하고 등록된 보험모집종사자에게 설명을 받으시기 바랍니다.<div style="margin-top:10px;color:#333;font-weight:750">보험협회 공유번호: 20260217401069</div><div style="display:flex;gap:14px;flex-wrap:wrap;margin-top:10px"><a href="https://www.e-cleanins.or.kr/" target="_blank" rel="noopener noreferrer" style="color:#111;font-weight:800">이클린보험서비스에서 정보 확인</a><a href="/insurance-notice/" style="color:#111;font-weight:800">보험정보 이용안내</a><a href="/privacy/" style="color:#111;font-weight:800">개인정보처리방침</a><a href="/terms/" style="color:#111;font-weight:800">이용약관</a></div></div></section>`;
